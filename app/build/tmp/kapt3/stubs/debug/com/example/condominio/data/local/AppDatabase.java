...
@androidx.room.Database(entities = {com.example.condominio.data.local.entity.UserEntity.class, com.example.condominio.data.local.entity.PaymentEntity.class}, version = 2, exportSchema = false)
