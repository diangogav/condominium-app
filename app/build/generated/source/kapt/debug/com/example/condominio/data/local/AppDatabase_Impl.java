  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `users` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `email` TEXT NOT NULL, `apartmentUnit` TEXT NOT NULL, `building` TEXT NOT NULL, PRIMARY KEY(`id`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '807abe9f9d0768bd7f763f771c42e41f')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsUsers.put("building", new TableInfo.Column("building", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "807abe9f9d0768bd7f763f771c42e41f", "b4707f125deec5843bc18927098a4999");
