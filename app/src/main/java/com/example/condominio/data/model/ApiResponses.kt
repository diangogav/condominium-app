...
data class PaymentSummaryDto(
        ...
        @SerializedName("total_debt") val totalDebt: Double? = 0.0
)
...
data class BalanceDto(
        ...
        @SerializedName("pendingInvoices") val pendingInvoicesCount: Int,
...
data class AllocationDto(@SerializedName("invoice_id") val invoiceId: String, val amount: Double)
